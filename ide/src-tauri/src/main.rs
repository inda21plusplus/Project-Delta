use std::{path::PathBuf, sync::{Mutex, Arc}, process::{Child, Stdio}, ops::DerefMut, io::{Write, Read}};
...
fn main() {
  tauri::Builder::default()
    ...
    .invoke_handler(tauri::generate_handler![select_game, play_game, stop_game, pause_game, unpause_game])
